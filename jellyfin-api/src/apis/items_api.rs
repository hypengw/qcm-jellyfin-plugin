...
/// struct for typed successes of method [`get_item_user_data`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetItemUserDataSuccess {
    Status200(models::UserItemDataDto),
    UnknownValue(serde_json::Value),
}

/// struct for typed successes of method [`get_items`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetItemsSuccess {
    Status200(models::BaseItemDtoQueryResult),
    UnknownValue(serde_json::Value),
}

/// struct for typed successes of method [`get_resume_items`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetResumeItemsSuccess {
    Status200(models::BaseItemDtoQueryResult),
    UnknownValue(serde_json::Value),
}

/// struct for typed successes of method [`update_item_user_data`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum UpdateItemUserDataSuccess {
    Status200(models::UserItemDataDto),
    UnknownValue(serde_json::Value),
}
...
pub async fn get_item_user_data(configuration: &configuration::Configuration, params: GetItemUserDataParams) -> Result<ResponseContent<GetItemUserDataSuccess>, Error<GetItemUserDataError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetItemUserDataSuccess> = serde_json::from_str(&local_var_content).ok();
...
pub async fn get_items(configuration: &configuration::Configuration, params: GetItemsParams) -> Result<ResponseContent<GetItemsSuccess>, Error<GetItemsError>> {
    let local_var_configuration = configuration;
    ...
    let index_number = params.index_number;
    ...
    if let Some(ref local_var_str) = index_number {
        local_var_req_builder = local_var_req_builder.query(&[("indexNumber", &local_var_str.to_string())]);
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetItemsSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
...
pub async fn get_resume_items(configuration: &configuration::Configuration, params: GetResumeItemsParams) -> Result<ResponseContent<GetResumeItemsSuccess>, Error<GetResumeItemsError>> {
    let local_var_configuration = configuration;
    ...
    let enable_total_record_count = params.enable_total_record_count;
    let enable_images = params.enable_images;
    let exclude_active_sessions = params.exclude_active_sessions;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetResumeItemsSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
...
pub async fn update_item_user_data(configuration: &configuration::Configuration, params: UpdateItemUserDataParams) -> Result<ResponseContent<UpdateItemUserDataSuccess>, Error<UpdateItemUserDataError>> {
    let local_var_configuration = configuration;

    // unbox the parameters
    let item_id = params.item_id;
    let update_user_item_data_dto = params.update_user_item_data_dto;
    let user_id = params.user_id;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<UpdateItemUserDataSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
