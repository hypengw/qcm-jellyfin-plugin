...
/// struct for typed successes of method [`get_music_genre`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetMusicGenreSuccess {
    Status200(models::BaseItemDto),
    UnknownValue(serde_json::Value),
}

/// struct for typed successes of method [`get_music_genres`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetMusicGenresSuccess {
...
pub async fn get_music_genre(configuration: &configuration::Configuration, params: GetMusicGenreParams) -> Result<ResponseContent<GetMusicGenreSuccess>, Error<GetMusicGenreError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetMusicGenreSuccess> = serde_json::from_str(&local_var_content).ok();
...
pub async fn get_music_genres(configuration: &configuration::Configuration, params: GetMusicGenresParams) -> Result<ResponseContent<GetMusicGenresSuccess>, Error<GetMusicGenresError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetMusicGenresSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
