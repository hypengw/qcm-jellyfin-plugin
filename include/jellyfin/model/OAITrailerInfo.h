 ...
 * OAITrailerInfo.h
 * name: TrailerInfo
 * schemaName: TrailerInfo
 * classFilename: TrailerInfo
 * classVarName: TrailerInfo
 * dataType: rc&lt;json_t&gt;
 * isNullable: false
 * isDeprecated: false
...
namespace jellyfin::model {
    ...
    extern void to_json(json_t&, const OAITrailerInfo&);
    extern void from_json(const json_t&, OAITrailerInfo&);
} // namespace jellyfin::model
DECLARE_CONVERT(std::string, jellyfin::model::OAITrailerInfo);
